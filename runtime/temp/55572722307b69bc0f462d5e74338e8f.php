<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:86:"D:\phpenv\Apache24\htdocs\thinkphp5\public/../application/index\view\student\edit.html";i:1482803785;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-3">
                        <select name="klass_id" id="klassId" class="form-control">
                            ...
                            <?php foreach($student->Klass->all() as $klass): ?>
                                <option value="<?php echo $klass->id; ?>"<?php if($student->getData('klass_id') == $klass->id): ?>selected="selected"<?php endif; ?>><?php echo $klass->name; ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                </div>
